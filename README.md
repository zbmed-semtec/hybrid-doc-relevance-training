...
1. **Simply injecting new embeddings without removing/replacing the previously identified MeSH words (i.e. No Reduction):**
...
```
1. **Introducing new embeddings while optionally removing/replacing the previously identified MeSH words (i.e. either with or without Reduction):**

...
The Word Mover's Distance (WMD) quantifies the **dissimilarity** between two text documents by determining the minimum distance necessary for the embedded words of one document to "travel" in the word embedding space and align with the embedded words of another document [1](http://mkusner.github.io/publications/WMD.pdf)

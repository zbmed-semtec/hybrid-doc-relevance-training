# Hybrid-Pre-fastText
This directory contains the code for the Hybrid-Pre-fastText approach. This method leverages the pre-annotated text of the RELISH corpus, utilizes the fastText model to generate word embeddings, and calculates their centroid to produce document embeddings.

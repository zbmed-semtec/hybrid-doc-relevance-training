...
if __name__ == "__main__":
    ...
    parameter_file = os.path.join(os.curdir, "code/fasttext/hyperparameters.yaml")
    ...
    # 14) Find MeSH-terms in the data in order to append the corresponding MeSHIDs' to tokens

...
In order to start the pipeline execution use this script, and run the following command:
 ...
 ``` 
python3 code/word2doc2vec/pre/main.py [-i INPUT] [-v VALIDATION_FILE] [-t TEST_FILE] [-g GROUND_TRUTH] [-c NO_OF CLASSES] [-win WINDOWS/LINUX]
 ``` 
...
To run this script, please execute the following command:
 ...
 ``` 
python3 code/word2doc2vec/pre/main.py -i data/Split_Dataset/train.npy -t data/Split_Dataset/test.npy -g data/Split_Dataset/Ground_truth/test.tsv -c 3 -win 0
 ``` 

...
def run(best_params, args):
    ...
    # 5) Replace MeSH-terms in tokens with the corresponding MeSHIDs
    ...
    # 7) Generate the cosine similarity validation matrix: pd.DataFrame for the generated embeddings

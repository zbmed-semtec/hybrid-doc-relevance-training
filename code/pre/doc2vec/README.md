...
In order to start the pipeline execution use this script, and run the following command:
 ...
 ``` 
python3 code/pre/doc2vec/main.py [-i INPUT] [-v VALIDATION_FILE] [-t TEST_FILE] [-gv VALIDATION_GROUND_TRUTH] [-gt TEST_GROUND_TRUTH] [-c NO_OF CLASSES] [-win WINDOWS/LINUX]
 ``` 
...
To run this script, please execute the following command:
 ...
 ``` 
python3 code/pre/doc2vec/main.py -i data/Split_Dataset/train.npy -v data/Split_Dataset/valid.npy -t data/Split_Dataset/test.npy -gv data/Split_Dataset/Ground_truth/valid.tsv -gt data/Split_Dataset/Ground_truth/test.tsv -c 3 -win 0
 ``` 
...
``` 
python3 code/pre/doc2vec/main.py -i data/Split_Dataset/train.npy -v data/Split_Dataset/test.npy -t data/Split_Dataset/test.npy -gv data/Split_Dataset/Ground_truth/test.tsv -gt data/Split_Dataset/Ground_truth/test.tsv -c 3 -win 0
``` 
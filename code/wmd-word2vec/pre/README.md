...
This directory contains the code for the Hybrid-Pre-WMD-Word2vec approach. This method leverages the pre-annotated text of the RELISH corpus, utilizes the word2vec model to generate word embeddings, and calculates their centroid to produce document embeddings.
...
+ Embedding Generation: Generates word embeddings for the remaining 20% of the test split data using the trained model.
+ WMD Similarity Computation: Calculates word mover's distance between the tokens of document pairs.
...
In order to start the pipeline execution use this script, and run the following command:
 ...
 ``` 
python3 code/pre/wmd-word2vec/main.py [-i INPUT] [-v VALIDATION_FILE] [-t TEST_FILE] [-gv VALIDATION_GROUND_TRUTH] [-gt TEST_GROUND_TRUTH] [-c NO_OF CLASSES] [-win WINDOWS/LINUX]
 ``` 
...
To run this script, please execute the following command:
 ...
 ``` 
python3 code/pre/wmd-word2vec/main.py -i data/Split_Dataset/train.npy -v data/Split_Dataset/valid.npy -t data/Split_Dataset/test.npy -gv data/Split_Dataset/Ground_truth/valid.tsv -gt data/Split_Dataset/Ground_truth/test.tsv -c 3 -win 0
 ``` 
...
``` 
python3 code/pre/wmd-word2vec/main.py -i data/Split_Dataset/train.npy -v data/Split_Dataset/test.npy -t data/Split_Dataset/test.npy -gv data/Split_Dataset/Ground_truth/test.tsv -gt data/Split_Dataset/Ground_truth/test.tsv -c 3 -win 0
``` 
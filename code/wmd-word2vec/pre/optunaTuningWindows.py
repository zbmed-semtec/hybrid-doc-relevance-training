...
def save_model_data(args, model, similarity):
    ...
    similarity_file = f"output_{args.classes}/validation/best_similarity_{args.classes}.tsv"
...
def run_optuna_optimization(args, params, n_trials, n_jobs=1):
    ...
    study = optuna.create_study(direction='maximize', study_name="Hybrid_Pre_WMD_Word2Vec_tuning", 
